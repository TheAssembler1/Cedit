...
static void Create_Edit_Menu(GtkWidget* header_bar){
    ...
    g_signal_connect(edit_undo_submenu_item, "activate", G_CALLBACK(Edit_Undo), NULL);
    g_signal_connect(edit_redo_submenu_item, "activate", G_CALLBACK(Edit_Redo), NULL);
    g_signal_connect(edit_cut_submenu_item, "activate", G_CALLBACK(Edit_Cut), NULL);
    g_signal_connect(edit_copy_submenu_item, "activate", G_CALLBACK(Edit_Copy), NULL);
    g_signal_connect(edit_paste_submenu_item, "activate", G_CALLBACK(Edit_Paste), NULL);
}
